...
public class AgendaDeConsultas {
    ...
    @Autowired
    private List<ValidadorAgendamentoDeConsulta> validadores; //o spring automaticamente gera uma lista com todas as classes q implementam essa interface
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados){
        ...
        //chamando cada um dos validadores
